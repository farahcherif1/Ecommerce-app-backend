...
import { comparePassword, generateHashPassword } from 'src/shared/utility/password-maanger';
  ...
  async create(createUserDto: CreateUserDto) {
    try{
      ...
      if (
        ...
        createUserDto.secretToken !== config.get('secretToken')
      ) {
      ...
      return {
        ...
        ? 'Admin created successfully' :
         'please verify your email, we have sent you an email with otp',
